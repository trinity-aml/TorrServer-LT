...
var msgRU = map[string]string{
	...
	"search_disabled_jacred":       "ℹ️ Поиск JacRed отключён в настройках",
	...
	"jacred_usage":                 "ℹ️ Использование: /jacred &lt;запрос&gt;",
	...
	"help_search_cmd":              "/search, /rutor, /torznab, /jacred",
	...
	"settings_set_jacred":          "Задать JacRed",
	"settings_clear_jacred":        "Очистить JacRed",
	"settings_jacred_test":         "Тест JacRed",
	"settings_hint_jacred":         "URL или URL|Key (напр. http://127.0.0.1:9117)",
	"settings_hint_jacred_test":    "URL|Key — проверка сервера JacRed",
	"settings_input_jacred_usage":  "Формат: URL или URL|Key",
	"settings_jacred_test_ok":      "✅ JacRed: подключение успешно",
	"settings_jacred_test_fail":    "❌ JacRed: %s",
