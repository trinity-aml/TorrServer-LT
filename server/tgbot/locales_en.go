...
var msgEN = map[string]string{
	...
	"settings_set_jacred":          "Set JacRed",
	"settings_clear_jacred":        "Clear JacRed",
	"settings_jacred_test":         "Test JacRed",
	"settings_hint_jacred":         "URL or URL|Key (e.g. http://127.0.0.1:9117)",
	"settings_hint_jacred_test":    "URL|Key — test the JacRed server",
	"settings_input_jacred_usage":  "Format: URL or URL|Key",
	"settings_jacred_test_ok":      "✅ JacRed: connection successful",
